...
class Tiket extends Model
{
    ...
    {
        $tiket = DB::table('tikets')
            ->select('tikets.id', 'tikets.aktif', 'tikets.no_tiket', 'tikets.created_at', 'tikets.pemohon', 'tikets.id_karyawan', 'statuses.status', 'tikets.judul', 'units.divisi', 'prioritas.tipe', 'tikets.lokasi', 'tikets.kerusakan', 'statuses.warna')
            // ->select('*')
            ->join('units', 'tikets.id_unit', 'units.id')
            ->join('prioritas', 'units.id_prioritas', 'prioritas.id')
            ->join('statuses', 'tikets.id_status', 'statuses.id')
